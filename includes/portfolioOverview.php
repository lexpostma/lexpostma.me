...
?>
            <a href="http://vimeo.com/<?=$videoid?>" class="video-in-link play" onclick="ga('send', 'event', 'Portfolio', 'Play video', '<?=$plainTitle?>');" style="background-image: url(/img/portfolio/<?=$shortname?>-1.png);" title="Play <?=$plainTitle?>'s video">
