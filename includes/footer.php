<footer id="pageFooter" class="copyright">
    <p>Designed and built by Lex Postma <span class="nowrap"><a href="<?=$coreURL?>copyright" title="Credits" onclick="ga('send', 'event', 'Navigation', 'Footer', 'Copyright');">&copy; 2010 - <?=date('Y')?></span></a>
