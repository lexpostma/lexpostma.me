        ...
        <div class="stats">
            ...
            <p><i class="fa fa-2x fa-twitter"></i><span class="counter"><? include 'stats/aboutStats-twitter.txt'; ?></span><a href="https://twitter.com/lexpostma" onclick="ga('send', 'event', 'About', 'Stats', 'Twitter followers');" title="Twitter profile">Twitter</a> followers</p>
