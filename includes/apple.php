...
<div id="top-apple">
    <img id="apple-lex" src="../img/logos/lex.svg" />
    <span>→</span>
    <img id="apple-logo" src="../img/logos/apple.svg" />
</div>
...
?>
<div class="apple-extra-img lef" id="apple-img1"><img src="../img/apple/apple-me.png" onclick="showDetails('apple-img1');"><p>This is me, hi!</p></div>
...
<div class="apple-extra-img rig" id="apple-img2"><img src="../img/apple/apple-crystalslide.png" onclick="showDetails('apple-img2');"><p><a onclick="ga('send', 'event', 'Apple', 'Portfolio bubbles', 'Crystal Slide');" href="http://lexpostma.me/crystal-slide">Crystal Slide</a>, revolving door design in Apple Stores</p></div>
...
<div class="apple-extra-img rig" id="apple-img4"><img src="../img/apple/apple-juicemonkey.png" onclick="showDetails('apple-img4');"><p><a onclick="ga('send', 'event', 'Apple', 'Portfolio bubbles', 'Juice Monkey');" href="http://lexpostma.me/juice-monkey">Juice Monkey</a>, citrus juicer for the creative's kitchen</p></div>
...
<div class="apple-extra-img rig" id="apple-img5"><img src="../img/apple/apple-rechtstreex1.png" onclick="showDetails('apple-img5');"><p><a onclick="ga('send', 'event', 'Apple', 'Portfolio bubbles', 'Experience on resumé');" href="http://lexpostma.me/resume#experience" <?/* blog.lexpostma.me/linking-a-dymo-scale-to-the-internet */?>>Prototyping</a> with Raspberry Pi Zero</p></div>
...
<div class="apple-extra-img lef" id="apple-img7"><img src="../img/apple/apple-whirlpoolbubble.png" onclick="showDetails('apple-img7');"><p>Redesigning and user testing the <a onclick="ga('send', 'event', 'Apple', 'Portfolio bubbles', 'Whirlpool Bubble');" href="http://lexpostma.me/whirlpool-bubble">Whirlpool Bubble</a> microwave</span></div>
...
<div class="apple-extra-img rig" id="apple-img8"><img src="../img/apple/apple-workplace.png" onclick="showDetails('apple-img8');"><p>Working hard in the workshop</p></div>
...
<div class="apple-extra-img lef notInline" id="apple-img3"><img src="../img/apple/apple-shaped.png" onclick="showDetails('apple-img3');"><p><a onclick="ga('send', 'event', 'Apple', 'Portfolio bubbles', 'Shaped');" href="http://lexpostma.me/shaped">Shaped</a>, run a route of a specific shape</span></div>
<div class="apple-extra-img lef notInline" id="apple-img6"><img src="../img/apple/apple-rechtstreex2.png" onclick="showDetails('apple-img6');"><p><a onclick="ga('send', 'event', 'Apple', 'Portfolio bubbles', 'Rechtstreex scale link');" href="http://lexpostma.me/rechtstreex-scale-link">Rechtstreex scale link</a>, connecting scales to the internet</p></div>
